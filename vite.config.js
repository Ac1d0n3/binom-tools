    ...
    plugins: [
        ...
        laravel({
            input: [
                ...
                'resources/js/tools/stakeholder-matrix/index.js',
                'resources/js/tools/report-inventory/index.js',
                ...
                'resources/js/tools/powerbi-dax-generator/index.js',
                ...
                'resources/js/tools/pureview-generator/index.js',
            ],
            refresh: true,
            fonts: [
