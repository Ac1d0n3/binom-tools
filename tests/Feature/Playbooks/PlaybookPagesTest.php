...
class PlaybookPagesTest extends TestCase
{
    public function test_playbook_index_lists_help_hub_story(): void
    {
        ...
        $response->assertSee('tools-filter-sidebar__collapse', false);
        ...
        $response->assertSee('data-overview-product="all"', false);
        $response->assertSee('data-i18n="overview.productTitle"', false);
        $response->assertSee('data-filter-tab="product"', false);
        $response->assertSee('data-filter-tab="category"', false);
        $response->assertSee('data-filter-tab="tags"', false);
        $response->assertSee('data-filter-tab-panel="product"', false);
        $response->assertSee('tools-filter-sidebar__tabs', false);
        $response->assertDontSee('tools-overview-product-filter', false);
