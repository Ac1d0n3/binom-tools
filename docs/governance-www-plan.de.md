...
Stories dürfen **freistehend** sein (Blog/News/Meinung/Fallbeispiel), ohne Pflicht-Anbindung an einen Learning Path. Learning Paths kuratieren Teilmengen für Journeys; Advisor und Paths verlinken kuratierte Guides. Blog-artige Posts müssen nicht in Sprint-Templates landen. Story-Bodies bleiben Markdown unter `content/stories/` (kein CMS in diesem Wave).
