    ...
    <div class="tools-content tools-content--wide sp-app admin-hub">
        ...
        <section class="sp-section">
            <x-admin.page-header title="Workspaces" titleDe="Workspaces" titleEn="Workspaces">
                <x-slot:actions>
                    <a href="{{ locale_route('admin.workspaces.create') }}" class="tools-btn tools-btn--primary">Create</a>
                </x-slot:actions>
            </x-admin.page-header>
            <div class="sp-list">
                    ...
                    <div class="sp-list__row">
                        ...
                        <div class="sp-list__actions">
                            @if (empty($ws['archived']))
                                ...
                                <form method="post" action="{{ locale_route('admin.workspaces.duplicate', ['workspaceId' => $ws['id']]) }}" style="display:inline">@csrf
                                    <button class="tools-btn tools-btn--small" type="submit">Duplicate</button>
                                </form>
                                <a class="tools-btn tools-btn--small" href="{{ locale_route('admin.workspaces.edit', ['workspaceId' => $ws['id']]) }}">Edit</a>
                                <form method="post" action="{{ locale_route('admin.workspaces.archive', ['workspaceId' => $ws['id']]) }}" style="display:inline">@csrf
