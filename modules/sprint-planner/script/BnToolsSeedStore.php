 ...
 * Packaged seed: modules/sprint-planner/script/bn-tools-seed/...
 */
final class BnToolsSeedStore
{
    ...
    public static function default(): self
    {
        return new self(
            ...
            base_path('modules/sprint-planner/script/bn-tools-seed'),
        );
    }

    public function seedDirectory(): string
    {
        return $this->seedDirectory ?: base_path('modules/sprint-planner/script/bn-tools-seed');
    }
