...
class GovernanceAdvisoryToolController extends Controller
{
    ...
    private function templateGuides(): array
    {
        return [
            ...
            'custom-stack-builder' => [
                ['placeholder' => 'Finance Analytics Stack 2026', 'help' => 'Kurzname für den dokumentierten Ist- oder Ziel-Stack.'],
                ['placeholder' => 'Fivetran, Airbyte', 'help' => 'Ingest/CDC-Produkte — über die Chips oben wählen.'],
                ['placeholder' => 'Snowflake, Fabric Lakehouse', 'help' => 'Storage/Warehouse-Produkte.'],
                ['placeholder' => 'dbt', 'help' => 'Transform-Produkte.'],
                ['placeholder' => 'Power BI, Tableau', 'help' => 'BI-/Semantic-Layer-Produkte.'],
                ['placeholder' => 'Purview, Unity Catalog', 'help' => 'Catalog- und Governance-Produkte.'],
                ['placeholder' => 'Airflow, Fabric Pipelines', 'help' => 'Orchestrierung.'],
                ['placeholder' => 'snowflake-dbt, fabric', 'help' => 'Abgeleitete Platform-Tags für Advisor und Filter (automatisch aus Chips).'],
                ['placeholder' => 'Catalog-Owner unklar, dbt Cloud vs. Airflow offen', 'help' => 'Offene Stack-Entscheidungen und Lücken.'],
            ],
    ...
    private function reportSummaries(): array
    {
        return [
            ...
            'custom-stack-builder' => 'Dieser Report dokumentiert den eigenen Stack je Funktion (Ingest, Storage, Transform, BI, Catalog, Orchestration) inklusive abgeleiteter Platform-Tags für Advisor und Governance-Filter.',
    ...
    private function fieldLabels(): array
    {
        return [
            ...
            'Stack name' => ['de' => 'Stack-Name', 'en' => 'Stack name'],
            'Ingest / CDC' => ['de' => 'Ingest / CDC', 'en' => 'Ingest / CDC'],
            'Storage / Warehouse' => ['de' => 'Storage / Warehouse', 'en' => 'Storage / Warehouse'],
            'Transform' => ['de' => 'Transform', 'en' => 'Transform'],
            'BI / Semantic' => ['de' => 'BI / Semantic', 'en' => 'BI / Semantic'],
            'Catalog / Governance' => ['de' => 'Catalog / Governance', 'en' => 'Catalog / Governance'],
            'Orchestration' => ['de' => 'Orchestration', 'en' => 'Orchestration'],
            'Platform tags' => ['de' => 'Platform-Tags', 'en' => 'Platform tags'],
        ...
        return [
            ...
            'governance-stack-advisor' => [
                ...
                'links' => [
                    ...
                    ['route' => 'tools.custom-stack-builder', 'label' => 'Build custom stack'],
                ],
            ],
            'custom-stack-builder' => [
                'title' => ['de' => 'Eigenen Stack bauen', 'en' => 'Custom Stack Builder'],
                'lead' => [
                    'de' => 'Dokumentiert den Ist- oder Ziel-Stack je Funktion: Produkte wählen, Tags ableiten, Lücken und nächste Tools sichtbar machen.',
                    'en' => 'Document the current or target stack by function: pick products, derive tags, and surface gaps plus next tools.',
                ],
                'icon' => 'fa-cubes',
                'question' => ['de' => 'Welche Produkte nutzen wir je Stack-Funktion — und was fehlt noch?', 'en' => 'Which products do we use per stack function — and what is still missing?'],
                'helps' => [
                    'Ingest, Storage, Transform, BI, Catalog und Orchestration getrennt erfassen.',
                    'Mischstacks (z. B. Snowflake + dbt + Power BI) ohne Preset-Zwang abbilden.',
                    'Platform-Tags für Advisor- und Hub-Filter ableiten.',
                    'Offene Entscheidungen und Anschlüsse zum Stack Advisor / Architecture Fit notieren.',
                ],
                'inputs' => ['Stack name', 'Ingest / CDC', 'Storage / Warehouse', 'Transform', 'BI / Semantic', 'Catalog / Governance', 'Orchestration'],
                'outputs' => ['Layer map', 'Product list', 'Platform tags', 'Gap notes', 'Next tool links'],
                'template' => ['Stack name', 'Ingest / CDC', 'Storage / Warehouse', 'Transform', 'BI / Semantic', 'Catalog / Governance', 'Orchestration', 'Platform tags', 'Open decisions'],
                'links' => [
                    ['route' => 'tools.governance-stack-advisor', 'label' => 'Open Stack Advisor'],
                    ['route' => 'tools.architecture-fit', 'label' => 'Run Architecture Fit'],
                ],
            ],
            'pii-dsdr-readiness-checker' => [
