@extends('foundations.layouts.tools', [
    'viteEntries' => ['modules/tools/js/pii-recommend-generator/index.js'],
])
...
@section('content')
    <x-tools.generator-page
        title-key="piiRec.pageTitle"
        tool-id="pii-recommend-generator"
        app-id="pii-recommend-generator-app"
    ...
    >
            ...
            <x-tools.sync-status id="rec-sync-status" />
    </x-tools.generator-page>
@endsection
