@extends('foundations.layouts.tools', [
    'viteEntries' => ['modules/tools/js/schema-yml-editor/index.js'],
])
        ...
        <div class="schema-yml-editor">
            <section class="schema-editor-panel" aria-labelledby="schema-sync-title">
                ...
                <div class="schema-editor-panel__actions">
                    ...
                    <a href="{{ locale_route('tools.pii-policy-generator') }}" class="tools-btn" data-i18n="schema.sync.openGenerator">Open PII Policy Generator</a>
                </div>
            </section>
