@extends('foundations.layouts.tools', [
    'viteEntries' => ['modules/tools/js/pii-unreviewed-gate-generator/index.js'],
])

@section('title', 'PII Table Gate Generator — ' . config('app.name'))
...
@section('content')
    ...
    >
            ...
            <x-tools.sync-status id="gate-sync-status" />
    </x-tools.generator-page>
@endsection
