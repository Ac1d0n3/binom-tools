@extends('foundations.layouts.tools', [
    'viteEntries' => ['modules/tools/js/powerbi-dax-generator/index.js'],
])
        ...
        <x-slot:help>
            ...
            <div class="qlik-set-help qlik-set-help--drawer" data-tool-help>
                <div class="qlik-set-help__links" aria-label="Power BI product links">
                            ...
                            <a class="qlik-set-help__link" href="{{ locale_route('playbooks.show', ['slug' => 'semantic-layer-vs-report-measure']) }}" data-powerbi-i18n="powerbiDax.help.semanticPlaybookLink">Semantic Layer vs Report</a>
                            <a class="qlik-set-help__link" href="{{ locale_route('playbooks.show', ['slug' => 'when-to-use-bi-formula-generators']) }}" data-powerbi-i18n="powerbiDax.help.formulaPlaybookLink">When formula generators help</a>
