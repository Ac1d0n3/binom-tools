@extends('foundations.layouts.tools', [
    'viteEntries' => ['modules/tools/js/tableau-calculation-generator/index.js'],
])
        ...
        <x-slot:help>
            ...
            <div class="qlik-set-help qlik-set-help--drawer" data-tool-help>
                <div class="qlik-set-help__links" aria-label="Tableau product links">
                            ...
                            <a class="qlik-set-help__link" href="{{ locale_route('playbooks.show', ['slug' => 'semantic-layer-vs-report-measure']) }}" data-tableau-i18n="tableauCalc.help.semanticPlaybookLink">Semantic Layer vs Report</a>
                            <a class="qlik-set-help__link" href="{{ locale_route('playbooks.show', ['slug' => 'when-to-use-bi-formula-generators']) }}" data-tableau-i18n="tableauCalc.help.formulaPlaybookLink">When formula generators help</a>
