---
type: sprint-plan
title: Third Quarter — Databricks Lakehouse / dbt / Power BI Governance & App Factory
slug: data-reporting-q3-databricks-dbt-powerbi
description: Q3 follow-up for Databricks Lakehouse/dbt/Power BI: make the first A-Z prototype production-ready, embed PII and DSDR controls, publish catalog/lineage and prepare the app factory for further Power BI apps.
duration: 13
unit: week
...
Thirteen Q3 weeks with two people: turn the first Databricks Lakehouse/dbt/Power BI slice into a production-ready, governable data and reporting building block. PII, DSDR, access, lineage, operations and app factory are implemented as real deliverables.

```sprint
id: week-01
number: 1
title: Take over Q2 results and close production gaps
goal: Databricks Lakehouse/dbt/Power BI: Take over Q2 results and close production gaps.
...
tasks:
  - id: q2-handover-production-gaps
    ...
    helpText: |
      ...
      Include Power BI app, data model, operations and privacy perspective together.
...
goal: Databricks Lakehouse/dbt/Power BI: Classify PII and sensitivity.
dependsOn: week-01
...
goal: Databricks Lakehouse/dbt/Power BI: Design DSDR and subject-right paths.
dependsOn: week-02
...
goal: Databricks Lakehouse/dbt/Power BI: Implement access, masking and role model.
dependsOn: week-03
...
goal: Databricks Lakehouse/dbt/Power BI: Harden privacy and export controls in the app.
dependsOn: week-04
...
goal: Databricks Lakehouse/dbt/Power BI: Make monitoring, alerting and runbook production-ready.
dependsOn: week-05
...
goal: Databricks Lakehouse/dbt/Power BI: Publish catalog, KPI registry and lineage.
dependsOn: week-06
...
goal: Databricks Lakehouse/dbt/Power BI: Automate DQ gates and release process.
dependsOn: week-07
...
goal: Databricks Lakehouse/dbt/Power BI: Business-sign off the first A-Z prototype.
dependsOn: week-08
...
goal: Databricks Lakehouse/dbt/Power BI: Shape the app factory template.
dependsOn: week-09
...
goal: Databricks Lakehouse/dbt/Power BI: Prepare the second app as repeatability slice.
dependsOn: week-10
...
goal: Databricks Lakehouse/dbt/Power BI: Run training and handover.
dependsOn: week-11
...
goal: Databricks Lakehouse/dbt/Power BI: Close Q3 and plan Q4 app rollout.
dependsOn: week-12
