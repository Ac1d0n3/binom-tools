---
type: sprint-plan
title: Drittes Quartal Parallel — Snowflake / dbt / Qlik App-Factory & nächste Apps
slug: data-reporting-q3-parallel-app-factory-snowflake-dbt-qlik
description: Optionaler Q3-Parallelplan für ein zweites Team: mit dem Snowflake/dbt/Qlik-Muster die nächsten Apps bauen. Ohne zweites Team kann dieser Plan als Q4-Anschlussplan genutzt werden.
duration: 13
unit: week
...
goal: Snowflake/dbt/Qlik: Nächste App-Kandidaten priorisieren.
...
tasks:
  - id: choose-next-apps
    ...
    helpText: |
      ...
      Beziehe Qlik-App, Datenmodell, DQ, Zugriff und Datenschutzsicht gemeinsam ein.
...
goal: Snowflake/dbt/Qlik: App 2 Scope, KPIs und Owner schneiden.
dependsOn: week-01
...
goal: Snowflake/dbt/Qlik: App 2 Quellen, PII und DSDR-Risiken prüfen.
dependsOn: week-02
...
goal: Snowflake/dbt/Qlik: App-Factory-Modellmuster anwenden.
dependsOn: week-03
...
goal: Snowflake/dbt/Qlik: App 2 Loads und Modell bauen.
dependsOn: week-04
...
goal: Snowflake/dbt/Qlik: App 2 DQ und Reconciliation umsetzen.
dependsOn: week-05
...
goal: Snowflake/dbt/Qlik: App 2 anbinden und erste Views bauen.
dependsOn: week-06
...
goal: Snowflake/dbt/Qlik: App 2 validieren und fachlich abnehmen.
dependsOn: week-07
...
goal: Snowflake/dbt/Qlik: App 3 als kleiner Wiederholungs-Slice schneiden.
dependsOn: week-08
...
goal: Snowflake/dbt/Qlik: App 3 Fundament vorbereiten.
dependsOn: week-09
...
goal: Snowflake/dbt/Qlik: Mit Q3-Governance-Team synchronisieren.
dependsOn: week-10
...
goal: Snowflake/dbt/Qlik: App-Factory-Artefakte paketieren.
dependsOn: week-11
...
goal: Snowflake/dbt/Qlik: Q4 Skalierungsplan schneiden.
dependsOn: week-12
