---
type: sprint-plan
title: Zweites Quartal — Databricks Lakehouse / dbt / Power BI Anschluss
slug: data-reporting-q2-databricks-dbt-powerbi
description: Q2-Anschluss an Databricks Lakehouse/dbt/Power BI: priorisierte App-Logik aus bestehenden Reports herausziehen, Star-Schema bauen, Delta Loads und SCD umsetzen und erste Power-BI-App-Items anbinden.
duration: 13
unit: week
...
Dreizehn Wochen Q2-Umsetzung mit zwei Personen: vorhandene App-Logik aus bestehenden Power-BI-Reports, Datasets, Notebooks, Jobs und vorgelagerten Logiken herausziehen, ein belastbares Star-Schema auf Delta-Tabellen mit inkrementellen Loads und Slowly Changing Dimensions bauen und den ersten nutzbaren Anschluss in die Power-BI-App liefern.

```sprint
id: week-01
number: 1
title: Bestehende App-Logik extrahieren
goal: Databricks Lakehouse/dbt/Power BI: Bestehende App-Logik extrahieren.
...
goal: Databricks Lakehouse/dbt/Power BI: Star-Schema und App-Scope schneiden.
dependsOn: week-01
...
goal: Databricks Lakehouse/dbt/Power BI: Quellen auf Zielmodell mappen.
dependsOn: week-02
...
goal: Databricks Lakehouse/dbt/Power BI: Delta Loads entwerfen.
dependsOn: week-03
...
goal: Databricks Lakehouse/dbt/Power BI: Slowly Changing Dimensions entwerfen.
dependsOn: week-04
...
goal: Databricks Lakehouse/dbt/Power BI: Staging- und Basis-Modelle bauen.
dependsOn: week-05
...
goal: Databricks Lakehouse/dbt/Power BI: Star-Schema bauen.
dependsOn: week-06
...
goal: Databricks Lakehouse/dbt/Power BI: DQ- und Reconciliation-Tests umsetzen.
dependsOn: week-07
...
goal: Databricks Lakehouse/dbt/Power BI: Gegen alte App-Werte validieren.
dependsOn: week-08
...
goal: Databricks Lakehouse/dbt/Power BI: Report-App anbinden.
dependsOn: week-09
...
goal: Databricks Lakehouse/dbt/Power BI: Erste App-Items anlegen.
dependsOn: week-10
...
goal: Databricks Lakehouse/dbt/Power BI: Betrieb, Runbook und Ownership haerten.
dependsOn: week-11
...
goal: Databricks Lakehouse/dbt/Power BI: Q2 abschliessen und Q3-Backlog schneiden.
dependsOn: week-12
