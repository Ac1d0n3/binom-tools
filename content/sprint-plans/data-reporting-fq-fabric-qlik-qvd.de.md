---
type: sprint-plan
title: Erstes Quartal — Fabric / QVD / Qlik gewachsen
slug: data-reporting-fq-fabric-qlik-qvd
description: Q1-Roadmap für eine gewachsene Fabric-/QVD-/Qlik-Landschaft mit unklaren Quellen, Skripten und Ownership: Daten- und Reporting-Landschaft verstehen, Risiken klären, wichtigste App festlegen und den A-Z-Prototyp für Q2 sauber vorbereiten.
duration: 13
unit: week
...
roadmap_phase: 1
roadmap_option: Weg 3 Gewachsene Fabric / QVD / Qlik Landschaft
...
Dreizehn Wochen, um die gewachsene Fabric-/QVD-/Qlik-Landschaft mit unklaren Quellen, Skripten und Ownership so zu verstehen, dass am Quartalsende eine belastbare App-Entscheidung, ein geschnittener A-Z-Prototyp und ein realistisches Q2-Umsetzungsbacklog vorliegen.
...
flowSteps:
  - Quellen (?)
  - Fabric / Exports (?)
  - QVD-Generatoren (SUBs/DELTAs/SCD)
  - QVD-Schichten
  - Qlik Script Apps
...
dependsOn: week-01
description: Fokus: Generator-Inventar, SUB-Bibliotheken, Delta-Logik, SCD-Muster, Owner je Generator, was „Source of Truth“ sein soll.
...
tasks:
  - id: build-pilot
    ...
    plannedMinutes: 1320
    demoCode: |
      // Checkliste QVD-Generator
      // 1) Wer besitzt die SUB?
      // 2) Incremental key / Delta-Quelle?
      // 3) SCD Typ (1/2/?) und Historie?
      // 4) Welche Apps lesen welche QVD-Schicht?
    assigneeType: person
    assigneeId: null
    helpText: |
