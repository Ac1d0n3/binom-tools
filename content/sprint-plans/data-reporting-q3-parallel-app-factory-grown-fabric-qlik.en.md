---
type: sprint-plan
title: Third Quarter Parallel — Grown Fabric / QVD / Qlik App Factory & Next Apps
slug: data-reporting-q3-parallel-app-factory-grown-fabric-qlik
description: Optional Q3 parallel plan for a second team: build the next apps from the grown Fabric/QVD/Qlik landscape. Without a second team, this plan can be used as the Q4 follow-up plan.
duration: 13
unit: week
...
goal: Fabric/Qlik: Prioritize next app candidates.
...
tasks:
  - id: choose-next-apps
    ...
    helpText: |
      ...
      For the grown landscape, cover both Q2 follow-up paths: Fabric Lakehouse/Qlik and Fabric+dbt as replacement for Qlik scripts.
...
goal: Fabric/Qlik: Cut App 2 scope, KPIs and owners.
dependsOn: week-01
...
goal: Fabric/Qlik: Check App 2 sources, PII and DSDR risks.
dependsOn: week-02
...
goal: Fabric/Qlik: Apply the app factory model pattern.
dependsOn: week-03
...
goal: Fabric/Qlik: Build App 2 loads and model.
dependsOn: week-04
...
goal: Fabric/Qlik: Implement App 2 DQ and reconciliation.
dependsOn: week-05
...
goal: Fabric/Qlik: Connect App 2 and build first views.
dependsOn: week-06
...
goal: Fabric/Qlik: Validate and sign off App 2.
dependsOn: week-07
...
goal: Fabric/Qlik: Cut App 3 as a small repeatability slice.
dependsOn: week-08
...
goal: Fabric/Qlik: Prepare App 3 foundation.
dependsOn: week-09
...
goal: Fabric/Qlik: Synchronize with Q3 governance team.
dependsOn: week-10
...
goal: Fabric/Qlik: Package app factory assets.
dependsOn: week-11
...
goal: Fabric/Qlik: Cut Q4 scaling plan.
dependsOn: week-12
