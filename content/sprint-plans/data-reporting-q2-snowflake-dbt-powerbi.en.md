---
type: sprint-plan
title: Second Quarter — Snowflake / dbt / Power BI follow-up
slug: data-reporting-q2-snowflake-dbt-powerbi
description: Q2 follow-up for Fivetran/Snowflake/dbt/Power BI: extract prioritized app logic from existing reports, build the star schema, implement delta loads and SCD, and connect first Power BI app items.
duration: 13
unit: week
...
roadmap_track_title: Snowflake / dbt / Power BI landscape
roadmap_phase: 2
roadmap_option: Path 2 Snowflake / dbt / Power BI
roadmap_follows:
...
Thirteen weeks of Q2 implementation with two people: extract existing app logic from existing Power BI reports, datasets, and upstream logic, build a reliable star schema with delta loads and slowly changing dimensions, and deliver the first usable connection into the Power BI app.

```sprint
id: week-01
number: 1
title: Extract existing app logic
goal: Snowflake/dbt/Power BI: Extract existing app logic.
...
goal: Snowflake/dbt/Power BI: Slice star schema and app scope.
dependsOn: week-01
...
goal: Snowflake/dbt/Power BI: Map sources to target model.
dependsOn: week-02
...
goal: Snowflake/dbt/Power BI: Design delta loads.
dependsOn: week-03
...
goal: Snowflake/dbt/Power BI: Design slowly changing dimensions.
dependsOn: week-04
...
goal: Snowflake/dbt/Power BI: Build staging and base models.
dependsOn: week-05
...
goal: Snowflake/dbt/Power BI: Build star schema.
dependsOn: week-06
...
goal: Snowflake/dbt/Power BI: Implement DQ and reconciliation tests.
dependsOn: week-07
...
goal: Snowflake/dbt/Power BI: Validate against old app values.
dependsOn: week-08
...
goal: Snowflake/dbt/Power BI: Connect report app.
dependsOn: week-09
...
goal: Snowflake/dbt/Power BI: Create first app items.
dependsOn: week-10
...
goal: Snowflake/dbt/Power BI: Harden operations, runbook, and ownership.
dependsOn: week-11
...
goal: Snowflake/dbt/Power BI: Close Q2 and slice Q3 backlog.
dependsOn: week-12
