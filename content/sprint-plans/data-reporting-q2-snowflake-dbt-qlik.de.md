---
type: sprint-plan
title: Zweites Quartal — Snowflake / dbt / Qlik Anschluss
slug: data-reporting-q2-snowflake-dbt-qlik
description: Q2-Anschluss an Fivetran/Snowflake/dbt/Qlik: priorisierte App-Logik aus bestehenden Reports herausziehen, Star-Schema bauen, Delta Loads und SCD umsetzen und erste Qlik-App-Items anbinden.
duration: 13
unit: week
...
Dreizehn Wochen Q2-Umsetzung mit zwei Personen: vorhandene App-Logik aus bestehenden Qlik-Apps und QVD-/Script-Logiken herausziehen, ein belastbares Star-Schema mit Delta Loads und Slowly Changing Dimensions bauen und den ersten nutzbaren Anschluss in die Qlik-App liefern.

```sprint
id: week-01
number: 1
title: Bestehende App-Logik extrahieren
goal: Snowflake/dbt/Qlik: Bestehende App-Logik extrahieren.
...
tasks:
  - id: extract-existing-logic
    ...
    assigneeId: null
    helpText: |
      Vorhandene Logik, Kennzahlen, Filter und Sonderskripte aus bestehenden Qlik-Apps und QVD-/Script-Logiken erfassen. Ziel ist nicht, alles zu kopieren, sondern die fachliche Logik vom Tool-Code zu trennen.
...
goal: Snowflake/dbt/Qlik: Star-Schema und App-Scope schneiden.
dependsOn: week-01
...
goal: Snowflake/dbt/Qlik: Quellen auf Zielmodell mappen.
dependsOn: week-02
...
goal: Snowflake/dbt/Qlik: Delta Loads entwerfen.
dependsOn: week-03
...
goal: Snowflake/dbt/Qlik: Slowly Changing Dimensions entwerfen.
dependsOn: week-04
...
goal: Snowflake/dbt/Qlik: Staging- und Basis-Modelle bauen.
dependsOn: week-05
...
goal: Snowflake/dbt/Qlik: Star-Schema bauen.
dependsOn: week-06
...
goal: Snowflake/dbt/Qlik: DQ- und Reconciliation-Tests umsetzen.
dependsOn: week-07
...
goal: Snowflake/dbt/Qlik: Gegen alte App-Werte validieren.
dependsOn: week-08
...
goal: Snowflake/dbt/Qlik: Report-App anbinden.
dependsOn: week-09
...
goal: Snowflake/dbt/Qlik: Erste App-Items anlegen.
dependsOn: week-10
...
goal: Snowflake/dbt/Qlik: Betrieb, Runbook und Ownership haerten.
dependsOn: week-11
...
goal: Snowflake/dbt/Qlik: Q2 abschliessen und Q3-Backlog schneiden.
dependsOn: week-12
