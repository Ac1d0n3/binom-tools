---
type: sprint-plan
title: Drittes Quartal — Snowflake / dbt / Qlik Governance & App-Factory
slug: data-reporting-q3-snowflake-dbt-qlik
description: Q3-Anschluss an Snowflake/dbt/Qlik: den ersten A-Z-Prototyp produktionsreif machen, PII und DSDR sauber verankern, Catalog/Lineage veröffentlichen und die App-Factory für weitere Apps vorbereiten.
duration: 13
unit: week
...
Dreizehn Wochen Q3 mit zwei Personen: aus dem ersten Snowflake/dbt/Qlik-Durchstich wird ein produktionsnaher, governance-faehiger Daten- und Reporting-Baustein. PII, DSDR, Zugriff, Lineage, Betrieb und App-Factory werden nicht nachtraeglich notiert, sondern als echte Liefergegenstaende umgesetzt.

```sprint
id: week-01
number: 1
title: Q2-Ergebnisse übernehmen und Produktionslücken schließen
goal: Snowflake/dbt/Qlik: Q2-Ergebnisse übernehmen und Produktionslücken schließen.
...
tasks:
  - id: q2-handover-production-gaps
    ...
    helpText: |
      ...
      Beziehe Qlik-App, Datenmodell, Betrieb und Datenschutzsicht gemeinsam ein.
...
goal: Snowflake/dbt/Qlik: PII- und Sensitivitätsklassifikation durchführen.
dependsOn: week-01
...
goal: Snowflake/dbt/Qlik: DSDR- und Auskunftspfade entwerfen.
dependsOn: week-02
...
goal: Snowflake/dbt/Qlik: Zugriff, Maskierung und Rollenmodell umsetzen.
dependsOn: week-03
...
goal: Snowflake/dbt/Qlik: Datenschutz- und Exportkontrollen in der App härten.
dependsOn: week-04
...
goal: Snowflake/dbt/Qlik: Monitoring, Alerting und Runbook produktionsreif machen.
dependsOn: week-05
...
goal: Snowflake/dbt/Qlik: Catalog, KPI-Registry und Lineage veröffentlichen.
dependsOn: week-06
...
goal: Snowflake/dbt/Qlik: DQ-Gates und Release-Prozess automatisieren.
dependsOn: week-07
...
goal: Snowflake/dbt/Qlik: Ersten A-Z-Prototyp fachlich abnehmen.
dependsOn: week-08
...
goal: Snowflake/dbt/Qlik: App-Factory-Template schneiden.
dependsOn: week-09
...
goal: Snowflake/dbt/Qlik: Zweite App als Wiederholungs-Slice vorbereiten.
dependsOn: week-10
...
goal: Snowflake/dbt/Qlik: Betriebsschulung und Übergabe durchführen.
dependsOn: week-11
...
goal: Snowflake/dbt/Qlik: Q3 abschließen und Q4 App-Rollout planen.
dependsOn: week-12
