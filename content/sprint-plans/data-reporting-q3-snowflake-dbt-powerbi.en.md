---
type: sprint-plan
title: Third Quarter — Snowflake / dbt / Power BI Governance & App Factory
slug: data-reporting-q3-snowflake-dbt-powerbi
description: Q3 follow-up for Snowflake/dbt/Power BI: make the first A-Z prototype production-ready, embed PII and DSDR controls, publish catalog/lineage and prepare the app factory for further Power BI apps.
duration: 13
unit: week
...
roadmap_follows:
  - data-reporting-q2-snowflake-dbt-powerbi
...
Thirteen Q3 weeks with two people: turn the first Snowflake/dbt/Power BI slice into a production-ready, governable data and reporting building block. PII, DSDR, access, lineage, operations and app factory are implemented as real deliverables.

```sprint
id: week-01
number: 1
title: Take over Q2 results and close production gaps
goal: Snowflake/dbt/Power BI: Take over Q2 results and close production gaps.
...
goal: Snowflake/dbt/Power BI: Classify PII and sensitivity.
dependsOn: week-01
...
goal: Snowflake/dbt/Power BI: Design DSDR and subject-right paths.
dependsOn: week-02
...
goal: Snowflake/dbt/Power BI: Implement access, masking and role model.
dependsOn: week-03
...
goal: Snowflake/dbt/Power BI: Harden privacy and export controls in the app.
dependsOn: week-04
...
goal: Snowflake/dbt/Power BI: Make monitoring, alerting and runbook production-ready.
dependsOn: week-05
...
goal: Snowflake/dbt/Power BI: Publish catalog, KPI registry and lineage.
dependsOn: week-06
...
goal: Snowflake/dbt/Power BI: Automate DQ gates and release process.
dependsOn: week-07
...
goal: Snowflake/dbt/Power BI: Business-sign off the first A-Z prototype.
dependsOn: week-08
...
goal: Snowflake/dbt/Power BI: Shape the app factory template.
dependsOn: week-09
...
goal: Snowflake/dbt/Power BI: Prepare the second app as repeatability slice.
dependsOn: week-10
...
goal: Snowflake/dbt/Power BI: Run training and handover.
dependsOn: week-11
...
goal: Snowflake/dbt/Power BI: Close Q3 and plan Q4 app rollout.
dependsOn: week-12
