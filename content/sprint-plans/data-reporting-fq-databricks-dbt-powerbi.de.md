---
type: sprint-plan
title: Erstes Quartal — Databricks Lakehouse → dbt → Power BI
slug: data-reporting-fq-databricks-dbt-powerbi
description: Q1-Roadmap für eine Databricks-Lakehouse-Landschaft mit Quellintegration, Delta, Unity Catalog, dbt und Power BI: Daten- und Reporting-Landschaft verstehen, Risiken klären, wichtigste App festlegen und den A-Z-Prototyp für Q2 sauber vorbereiten.
duration: 13
unit: week
...
Dreizehn Wochen, um die Databricks-Lakehouse-Landschaft mit Quellintegration, Delta, Unity Catalog, dbt und Power BI so zu verstehen, dass am Quartalsende eine belastbare App-Entscheidung, ein geschnittener A-Z-Prototyp und ein realistisches Q2-Umsetzungsbacklog vorliegen.
