---
type: sprint-plan
title: Create new app data model — Snowflake / dbt / Power BI landscape
slug: app-data-model-snowflake-dbt-powerbi
...
goal: Snowflake/dbt/Power BI: Define app goal, grain and KPI cut.
...
tasks:
  - id: scope-model
    ...
    helpText: |
      ...
      Consider Snowflake/dbt/Power BI, Power BI app, model, DQ, access and privacy together.
...
goal: Snowflake/dbt/Power BI: Check sources, PII and DSDR.
dependsOn: week-01
...
goal: Snowflake/dbt/Power BI: Design facts, dimensions and history.
dependsOn: week-02
...
goal: Snowflake/dbt/Power BI: Build staging and business model.
dependsOn: week-03
...
goal: Snowflake/dbt/Power BI: Add DQ, catalog and lineage.
dependsOn: week-04
...
goal: Snowflake/dbt/Power BI: Validate model and hand over to app build.
dependsOn: week-05
