---
type: sprint-plan
title: Create new app data model — Snowflake / dbt / Qlik landscape
...
goal: Snowflake/dbt/Qlik: Define app goal, grain and KPI cut.
...
goal: Snowflake/dbt/Qlik: Check sources, PII and DSDR.
dependsOn: week-01
...
goal: Snowflake/dbt/Qlik: Design facts, dimensions and history.
dependsOn: week-02
...
goal: Snowflake/dbt/Qlik: Build staging and business model.
dependsOn: week-03
...
goal: Snowflake/dbt/Qlik: Add DQ, catalog and lineage.
dependsOn: week-04
...
goal: Snowflake/dbt/Qlik: Validate model and hand over to app build.
dependsOn: week-05
