---
type: sprint-plan
title: Third Quarter Parallel — Snowflake / dbt / Power BI App Factory & Next Apps
slug: data-reporting-q3-parallel-app-factory-snowflake-dbt-powerbi
description: Optional Q3 parallel plan for a second team: use the Snowflake/dbt/Power BI pattern to build the next apps. Without a second team, this plan can be used as the Q4 follow-up plan.
duration: 13
unit: week
...
goal: Snowflake/dbt/Power BI: Prioritize next app candidates.
...
goal: Snowflake/dbt/Power BI: Cut App 2 scope, KPIs and owners.
dependsOn: week-01
...
goal: Snowflake/dbt/Power BI: Check App 2 sources, PII and DSDR risks.
dependsOn: week-02
...
goal: Snowflake/dbt/Power BI: Apply the app factory model pattern.
dependsOn: week-03
...
goal: Snowflake/dbt/Power BI: Build App 2 loads and model.
dependsOn: week-04
...
goal: Snowflake/dbt/Power BI: Implement App 2 DQ and reconciliation.
dependsOn: week-05
...
goal: Snowflake/dbt/Power BI: Connect App 2 and build first views.
dependsOn: week-06
...
goal: Snowflake/dbt/Power BI: Validate and sign off App 2.
dependsOn: week-07
...
goal: Snowflake/dbt/Power BI: Cut App 3 as a small repeatability slice.
dependsOn: week-08
...
goal: Snowflake/dbt/Power BI: Prepare App 3 foundation.
dependsOn: week-09
...
goal: Snowflake/dbt/Power BI: Synchronize with Q3 governance team.
dependsOn: week-10
...
goal: Snowflake/dbt/Power BI: Package app factory assets.
dependsOn: week-11
...
goal: Snowflake/dbt/Power BI: Cut Q4 scaling plan.
dependsOn: week-12
