---
type: sprint-plan
title: Third Quarter Parallel — Snowflake / dbt / Qlik App Factory & Next Apps
slug: data-reporting-q3-parallel-app-factory-snowflake-dbt-qlik
description: Optional Q3 parallel plan for a second team: use the Snowflake/dbt/Qlik pattern to build the next apps. Without a second team, this plan can be used as the Q4 follow-up plan.
duration: 13
unit: week
...
goal: Snowflake/dbt/Qlik: Prioritize next app candidates.
...
tasks:
  - id: choose-next-apps
    ...
    helpText: |
      ...
      Include Qlik app, data model, DQ, access and privacy perspective together.
...
goal: Snowflake/dbt/Qlik: Cut App 2 scope, KPIs and owners.
dependsOn: week-01
...
goal: Snowflake/dbt/Qlik: Check App 2 sources, PII and DSDR risks.
dependsOn: week-02
...
goal: Snowflake/dbt/Qlik: Apply the app factory model pattern.
dependsOn: week-03
...
goal: Snowflake/dbt/Qlik: Build App 2 loads and model.
dependsOn: week-04
...
goal: Snowflake/dbt/Qlik: Implement App 2 DQ and reconciliation.
dependsOn: week-05
...
goal: Snowflake/dbt/Qlik: Connect App 2 and build first views.
dependsOn: week-06
...
goal: Snowflake/dbt/Qlik: Validate and sign off App 2.
dependsOn: week-07
...
goal: Snowflake/dbt/Qlik: Cut App 3 as a small repeatability slice.
dependsOn: week-08
...
goal: Snowflake/dbt/Qlik: Prepare App 3 foundation.
dependsOn: week-09
...
goal: Snowflake/dbt/Qlik: Synchronize with Q3 governance team.
dependsOn: week-10
...
goal: Snowflake/dbt/Qlik: Package app factory assets.
dependsOn: week-11
...
goal: Snowflake/dbt/Qlik: Cut Q4 scaling plan.
dependsOn: week-12
