---
type: sprint-plan
title: Build new app on existing model with model filter — Snowflake / dbt / Power BI landscape
...
goal: Snowflake/dbt/Power BI: Cut filter logic, audience and risk.
...
goal: Snowflake/dbt/Power BI: Implement model filter and app behavior.
dependsOn: week-01
...
goal: Snowflake/dbt/Power BI: Check filter test matrix and security.
dependsOn: week-02
...
goal: Snowflake/dbt/Power BI: Accept and publish filtered app.
dependsOn: week-03
