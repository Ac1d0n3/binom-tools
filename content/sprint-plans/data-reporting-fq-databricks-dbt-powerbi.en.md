---
type: sprint-plan
title: First Quarter — Databricks Lakehouse → dbt → Power BI
slug: data-reporting-fq-databricks-dbt-powerbi
description: Q1 roadmap for a Databricks Lakehouse landscape with source integration, Delta, Unity Catalog, dbt, and Power BI: understand the data and reporting landscape, clarify risks, choose the most important app, and prepare the A-Z prototype for Q2.
duration: 13
unit: week
...
Thirteen weeks to understand the Databricks Lakehouse landscape with source integration, Delta, Unity Catalog, dbt, and Power BI well enough to end the quarter with a committed app decision, a sliced A-Z prototype, and a realistic Q2 implementation backlog.
...
dependsOn: week-01
description: Focus: dataset/semantic model ownership, measures vs warehouse definitions, refresh and workspace rights.
