...
const shellLabels = {
    de: {
        ...
        'nav.dbt-governance-macro-generator': 'Macro Generator',
        'nav.pii-recommend-generator': 'Recommend Generator',
        'card.dbt-governance-macro-generator.title': 'Macro Generator',
        ...
        'card.pii-recommend-generator.title': 'Recommend Generator',
        ...
        'workflow.step-dbt-governance-macro-generator': 'Macro Generator',
        'workflow.step-pii-policy-generator': 'Policy Generator',
        'workflow.step-pii-unreviewed-gate-generator': 'Table Gate',
        'workflow.step-pii-recommend-generator': 'Recommend Generator',
        'workflow.step-dbt-dq-macro-generator': 'Macro Generator',
        'workflow.step-dbt-dq-rules-generator': 'Rules Generator',
        'workflow.step-dbt-dq-history-generator': 'History Generator',
        'nav.dbt-dq-macro-generator': 'Macro Generator',
        'card.dbt-dq-macro-generator.title': 'Macro Generator',
        'card.dbt-dq-macro-generator.description':
            'Schritt 1/3: Laufzeit-Makros, Generic Test dq_rule und SETUP_DQ.md für dein dbt-Projekt.',
        'nav.dbt-dq-rules-generator': 'Rules Generator',
        'card.dbt-dq-rules-generator.title': 'Rules Generator',
        'card.dbt-dq-rules-generator.description':
            'Schritt 2/3: meta.dq_rules in schema.yml — Regeln pro Spalte und Model.',
        'nav.dbt-dq-history-generator': 'History Generator',
        'card.dbt-dq-history-generator.title': 'History Generator',
        'card.dbt-dq-history-generator.description':
            'Schritt 3/3: dq_run_history, Report-Views und dq_collect_results Runbook.',
        'nav.pii-unreviewed-gate-generator': 'Table Gate',
        'card.pii-unreviewed-gate-generator.title': 'Table Gate',
        ...
        'nav.pii-policy-generator': 'Policy Generator',
        'card.pii-policy-generator.title': 'Policy Generator',
    ...
    en: {
        ...
        'card.dbt-dq-macro-generator.title': 'Macro Generator',
        'card.dbt-dq-macro-generator.description':
            'Step 1/3: Runtime macros, dq_rule generic test, and SETUP_DQ.md for your dbt project.',
        'nav.dbt-dq-rules-generator': 'Rules Generator',
        'card.dbt-dq-rules-generator.title': 'Rules Generator',
        'card.dbt-dq-rules-generator.description':
            'Step 2/3: meta.dq_rules in schema.yml — rules per column and model.',
        'nav.dbt-dq-history-generator': 'History Generator',
        'card.dbt-dq-history-generator.title': 'History Generator',
        'card.dbt-dq-history-generator.description':
            'Step 3/3: dq_run_history, report views, and dq_collect_results runbook.',
        'nav.pii-unreviewed-gate-generator': 'Table Gate',
        'card.pii-unreviewed-gate-generator.title': 'Table Gate',
        'card.pii-unreviewed-gate-generator.description':
