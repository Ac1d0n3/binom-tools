...
const shellLabels = {
    de: {
        ...
        'accounts.colorHint': 'Volle Farben oder Outline (weißer Hintergrund + farbiger Rahmen).',
    ...
    en: {
        ...
        'accounts.colorHint': 'Solid fills or outlined chips (white background + colored border).',
        'accounts.avatarIcon': 'Avatar icon',
