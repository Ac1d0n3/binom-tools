...
export const promptStudioLabels = {
    de: {
        ...
        'promptStudio.promptLocale': 'Prompt-Sprache',
        'promptStudio.promptLocale.hint': 'Nur die Vorschau — die Seite bleibt in der gewählten Sprache.',
    ...
    en: {
        ...
        'promptStudio.promptLocale': 'Prompt language',
        'promptStudio.promptLocale.hint': 'Preview only — the page stays in your UI language.',
        'promptStudio.kind.prompt': 'Prompt',
