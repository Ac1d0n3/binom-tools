...
export const promptStudioLabels = {
    de: {
        ...
        'promptStudio.library.title': 'Aufgaben & Workflows',
        ...
        'promptStudio.builder.lead':
            'Aufgabe wählen: Prompt kopieren — oder Projekt-Rule / Agent-Aufgabe als .md herunterladen.',
        ...
        'promptStudio.kindFilter.all': 'Alle Arten',
    ...
    en: {
        ...
        'promptStudio.library.title': 'Tasks & workflows',
        'promptStudio.tabs.workflows': 'Workflows',
        ...
        'promptStudio.builder.lead':
            'Pick a task: copy a prompt — or download a project rule / agent task as .md.',
