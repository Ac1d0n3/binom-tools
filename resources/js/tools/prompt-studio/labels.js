...
export const promptStudioLabels = {
    de: {
        ...
        'promptStudio.field.uiOnly': 'nur UI',
        'promptStudio.structure.loadPreset': 'Genre-Preset laden',
        'promptStudio.structure.insertBuildUp': 'Build-up einfügen',
        'promptStudio.structure.addSection': 'Abschnitt hinzufügen',
        'promptStudio.structure.placeholder': 'Intro (4 bars)\nVerse 1 (16 bars)\n…',
        'promptStudio.structure.buildUpTipFallback': 'Tipp: Vor dem Refrain/Drop ein Build-up oder Pre-Chorus einplanen.',
        'promptStudio.lyricsMeter.syllables': 'Silben',
        'promptStudio.lyricsMeter.bars': 'Bars',
        'promptStudio.lyricsMeter.uiOnly': 'Nicht im Copy-Prompt',
        'promptStudio.lyricsMeter.placeholder': 'Zeile für Zeile Lyrics entwerfen…',
        'promptStudio.lyricsMeter.applyToStory': 'Draft → Story übernehmen',
    ...
    en: {
        ...
        'promptStudio.field.chipsPlaceholder': 'a, b, c',
        'promptStudio.field.uiOnly': 'UI only',
        'promptStudio.structure.loadPreset': 'Load genre preset',
        'promptStudio.structure.insertBuildUp': 'Insert build-up',
        'promptStudio.structure.addSection': 'Add section',
        'promptStudio.structure.placeholder': 'Intro (4 bars)\nVerse 1 (16 bars)\n…',
        'promptStudio.structure.buildUpTipFallback': 'Tip: plan a build-up or pre-chorus before the chorus/drop.',
        'promptStudio.lyricsMeter.syllables': 'Syllables',
        'promptStudio.lyricsMeter.bars': 'Bars',
        'promptStudio.lyricsMeter.uiOnly': 'Not in copy prompt',
        'promptStudio.lyricsMeter.placeholder': 'Draft lyrics line by line…',
        'promptStudio.lyricsMeter.applyToStory': 'Draft → apply to Story',
