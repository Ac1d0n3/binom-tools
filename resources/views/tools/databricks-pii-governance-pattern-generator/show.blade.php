@extends('layouts.tools', [
    'viteEntries' => ['resources/js/tools/databricks-dq-pattern-generator/index.js'],
])

@section('title', 'Databricks PII Governance Pattern Generator — ' . config('app.name'))

@section('content')
    <x-tools.generator-page
        title-key="lakehouseDq.databricksPii.pageTitle"
    ...
    >
        ...
        <x-tools.panel heading-id="lakehouse-dq-input-title" title-key="lakehouseDq.input.title" description-key="lakehouseDq.input.description">
            <div class="pii-policy-panel__grid">
                <x-tools.field label-key="lakehouseDq.input.table">
                    <input id="lakehouse-dq-table" class="pii-policy-input" type="text" value="main.customer.customer_app_curated">
                </x-tools.field>
                <x-tools.field label-key="lakehouseDq.input.keys">
                    <input id="lakehouse-dq-keys" class="pii-policy-input" type="text" value="customer_id">
                </x-tools.field>
                <x-tools.field label-key="lakehouseDq.input.required">
                    <input id="lakehouse-dq-required" class="pii-policy-input" type="text" value="customer_id, consent_status, updated_at">
                </x-tools.field>
                ...
                <x-tools.field label-key="lakehouseDq.input.pii">
                    <input id="lakehouse-dq-pii" class="pii-policy-input" type="text" value="customer_email, customer_name, phone">
                </x-tools.field>
                <x-tools.field label-key="lakehouseDq.input.owner">
                    <input id="lakehouse-dq-owner" class="pii-policy-input" type="text" value="data-owner-customer">
                </x-tools.field>
                <x-tools.field label-key="lakehouseDq.input.pattern">
                    <select id="lakehouse-dq-pattern" class="pii-policy-input">
                        <option value="governance" selected>Unity Catalog Gate</option>
                        <option value="dq">DQ Expectations</option>
                        <option value="delta">Delta MERGE</option>
        ...
        <x-tools.panel-code heading-id="lakehouse-dq-sql-title" title-key="lakehouseDq.databricks.output.sql" pre-id="lakehouse-dq-sql-pre" copy-btn-id="lakehouse-dq-copy-sql" copy-key="lakehouseDq.copy" />
        <x-tools.panel-code heading-id="lakehouse-dq-notebook-title" title-key="lakehouseDq.databricks.output.notebook" pre-id="lakehouse-dq-notebook-pre" copy-btn-id="lakehouse-dq-copy-notebook" copy-key="lakehouseDq.copy" />
