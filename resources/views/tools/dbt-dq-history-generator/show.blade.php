...
@section('content')
    <div class="tools-content tools-content--wide">
        <h1 class="tools-page-title" data-i18n="dqHistory.pageTitle">DQ History Generator</h1>

        <x-tools.workflow-nav tool-id="dbt-dq-history-generator" />

        <div class="pii-policy-generator" id="dbt-dq-history-generator-app">
            <div id="dq-history-validation-banner" class="tools-validation-banner" hidden role="alert"></div>
            ...
            <p class="pii-policy-sync-status" id="dq-history-sync-status" aria-live="polite"></p>
        </div>
    </div>
@endsection
