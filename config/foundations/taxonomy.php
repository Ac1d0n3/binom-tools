...
/**
 * TaxonomyFoundation — shared vocabulary IDs (file-first, no DB).
 *
 * Domains keep their own configs; reference these IDs where they match 1:1.
 * Local-only categories (e.g. glossary) may stay domain-local.
 */
return [
    'regions' => [
        'eu' => ['de' => 'EU', 'en' => 'EU'],
