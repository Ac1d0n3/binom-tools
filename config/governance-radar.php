    ...
    */
    'type_meta' => [
        ...
        'Binom News' => [
            ...
            'tone' => 'editorial',
            'order' => 70,
            'label' => ['de' => 'Binom News', 'en' => 'Binom News'],
        ],
    ],
    /*
    |--------------------------------------------------------------------------
    ...
    */
    'ingest' => [
        ...
        'source_type_to_item_type' => [
            ...
            'Eigene News' => 'Binom News',
            'Binom News' => 'Binom News',
            'Custom' => 'Governance News',
            'Eigene Quelle' => 'Binom News',
        ],
    ],
    'sources' => [
        [
        ...
        [
            ...
            'language' => 'de',
            'cadence' => 'manual',
            'topics' => ['Binom News', 'Best Practices', 'Playbooks'],
    ...
    'items' => [
        ...
        [
            ...
            'summary' => 'Neue Quellen sollten im Radar direkt mit KPI-Anforderungen, PII/DSDR, DQ-Regeln und Mart-Entscheidungen verbunden werden. Als Merksatz behalten: Binom News, Best Practices, Data Quality hängt mit angrenzenden Entscheidungen zusammen — in DE oft sichtbarer in Katalog, Freigabe oder Vendor-Reviews (stackübergreifend).',
            'published_at' => '2026-07-26',
            'type' => 'Binom News',
            'impact' => 'Info',
            'region' => 'DE',
            'topics' => ['Binom News', 'Best Practices', 'Data Quality'],
            'stack' => ['Alle Stacks'],
            'url' => '/governance',
