...
return [
    ...
    'nav' => [
        ...
        [
            ...
            'label' => [
                'de' => 'Recommend Generator',
                'en' => 'Recommend Generator',
            ],
            'description' => [
        ...
        [
            ...
            'description' => [
                'de' => 'Schritt 1/3: Laufzeit-Makros, Generic Test dq_rule und SETUP_DQ.md für dein dbt-Projekt.',
                'en' => 'Step 1/3: Runtime macros, dq_rule generic test, and SETUP_DQ.md for your dbt project.',
            ],
            'example' => true,
            'accent' => 'primary',
        ...
        [
            ...
            'description' => [
                'de' => 'Schritt 2/3: meta.dq_rules in schema.yml — Regeln pro Spalte und Model.',
                'en' => 'Step 2/3: meta.dq_rules in schema.yml — rules per column and model.',
            ],
            'example' => true,
            'accent' => 'accent',
            'workflow' => 'dbt-dq-governance',
        ...
        [
            ...
            'label' => [
                'de' => 'History Generator',
                'en' => 'History Generator',
            ],
            'description' => [
                'de' => 'Schritt 3/3: dq_run_history, Report-Views und dq_collect_results Runbook.',
                'en' => 'Step 3/3: dq_run_history, report views, and dq_collect_results runbook.',
            ],
            'example' => true,
            'accent' => 'primary',
            'workflow' => 'dbt-dq-governance',
